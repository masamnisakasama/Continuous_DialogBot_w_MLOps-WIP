...
基本GPT-5 ThikingとClaude Opus 4.1でUIや機能の大枠を作っています。依存関係が複雑だと大抵バグるので、バグったところは書き直しています。
...
- 類似度分析、PCA/t-SNE、類似文表示などもう使わない定義が山ほど溢れている。しかも場所もバラバラで非常に厳しい。消すのは勿体無いと思って消していなかったが、早めに整理ないと取り返しがつかない。使わないエンドポイント/conversation/up_and_searchなどもあるが、使うかもしれないと思っている。（よくない）
